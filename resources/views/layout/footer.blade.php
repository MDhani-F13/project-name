                    ...
                    <div class="row footer-hny-grids sub-columns">
                        <div class="col-lg-5 sub-one-left pe-lg-5">
                            ...
                            <p class="footer-phny mt-3">
                                ...
                                dalam setiap pelaksanaan pengiriman, demi tercapainya pelayanan yang prima demi kepuasan dan kepercayaan pelanggan.

                            </p>
                            <div class="columns-2 mt-4 pt-lg-2">
                            <p class="footer-phny mt-3">
                                Pesona Metropolitan Ruko Gardenia Blok RC 12 15
                                <br>
                                Jl. Raya Siliwangi KM. 7, Bekasi 17116
                                <br>
                                Phone : (62-21) 2936 7577 
                            </p>
                            </div>
                        </div>
